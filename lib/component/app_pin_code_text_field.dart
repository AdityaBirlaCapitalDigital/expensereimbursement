    ...
    return PinCodeTextField(
      ...
      // FlutterFlowTheme.of(context).bodyLarge.override
        TextStyle(
          ...
          color: hasError ? Color(0xFFC7222A) : Colors.black),
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      enableActiveFill: true,
      keyboardType: TextInputType.number,
      autoFocus: false,
      enablePinAutofill: widget.enableAutofill ?? false,
      showCursor: false,
      ...
      pinTheme: PinTheme(
        ...
        selectedColor: Color(0xFFC7222A),
        activeFillColor: hasError ? Color(0xFFFFE7E5) : Color(0xFFF1F3F6),
        inactiveFillColor: hasError ? Color(0xFFFFE7E5) : Color(0xFFF1F3F6),
      ...
      validator: (val) {
        if (widget.pinCodeController.text != widget.verificationCode) {
...
class PinCodeTextField extends StatefulWidget {
  ...
  PinCodeTextField({
    ...
    this.scrollPadding = const EdgeInsets.all(20), required suffixIcon,
