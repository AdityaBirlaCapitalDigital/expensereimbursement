...
import '../../bs_flutter_utils/bs_flutter_utils.dart';
import '../bs_flutter_selectbox.dart';
import 'components/bs_wrapper_option.dart';
    ...
    if (!widget.controller.multiple)
      children.add(
        DefaultTextStyle(
          ...
          child: Container(child: Text("${widget.controller.getSelected()!.getText()}")),
        ),
      );
